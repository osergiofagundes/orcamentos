...
import { OrcamentoDetails } from "./_components/orcamento-details"

interface PageProps {
  params: Promise<{ workspaceId: string; orcamentoId: string }>
}

export default async function OrcamentoDetailsPage({ params }: PageProps) {
    ...
    <SidebarProvider>
      ...
      <SidebarInset>
          ...
          <div className="flex items-center gap-2 px-4">
            ...
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbSeparator className="hidden md:block" />
                <BreadcrumbItem>
                  <BreadcrumbPage>Orçamento #{orcamentoId}</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
        ...
        <div className="flex flex-1 flex-col gap-6 p-6 pt-0">
          <OrcamentoDetails workspaceId={workspaceId} orcamentoId={orcamentoId} />
        </div>
      </SidebarInset>
    </SidebarProvider>
  )
